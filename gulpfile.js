...
gulp.task('htc', function() {
    gulp.src('dev/css/*.htc')
        .pipe(gulp.dest('dist/css'));
});

gulp.task('js-libs', function() {
	return gulp.src([
        'dev/js/libs/jquery-1.12.js',
        'dev/js/libs/lightslider.min.js',
        'dev/js/libs/masonry.min.js',
        'dev/js/libs/template.js',
        'dev/js/libs/matchmedia.poliphill.js',
        'dev/js/libs/respond.js'
    ])
...
gulp.task('build', ['clean', 'html', 'htc', 'img', 'build-fonts', 'sprite', 'sass', 'css-libs', 'js-libs', 'js-uglify']);
